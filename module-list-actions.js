...
(function(){
  ...
  document.addEventListener("click",function(e){var b=e.target&&e.target.closest&&e.target.closest("button,a");if(!b||!document.querySelector(".card"))return;var label=(b.textContent||"").toLocaleLowerCase("tr-TR").replace(/[^a-zçğıöşü]+/g," ").trim();if(label!=="liste")return;e.preventDefault();e.stopPropagation();if(e.stopImmediatePropagation)e.stopImmediatePropagation();openList();},true);
