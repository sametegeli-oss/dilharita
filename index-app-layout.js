...
(function(){
  ...
  function addStyle(){
    ...
    +"@media(max-width:520px){.card.dh-youtube-source-sentence>.dh-card-quickbar{display:flex!important;flex-flow:row nowrap!important;align-items:center!important;justify-content:center!important;gap:4px!important;overflow:visible!important}.card.dh-youtube-source-sentence>.dh-card-quickbar>.dh-card-actions-primary,.card.dh-youtube-source-sentence>.dh-card-quickbar>.dh-card-actions-primary>.dh-ai-row,.card.dh-youtube-source-sentence>.dh-card-quickbar>.dh-nav-trio,.card.dh-youtube-source-sentence>.dh-card-quickbar>.dh-source-media-row{display:contents!important}.card.dh-youtube-source-sentence>.dh-card-quickbar button{flex:1 1 0!important;width:auto!important;min-width:36px!important;max-width:46px!important;height:40px!important;min-height:40px!important;margin:0!important;padding:0!important;border-radius:12px!important}.card.dh-youtube-source-sentence>.dh-card-quickbar .dh-youtube-source-btn{display:inline-flex!important;font-size:0!important}.card.dh-youtube-source-sentence>.dh-card-quickbar .dh-youtube-source-btn:after{content:'▶';font-size:14px}}"
