...
ok(html.includes("ai-bulk-json-parser.js?v=1")&&html.indexOf("ai-bulk-json-parser")<html.indexOf("index-app-layout.js?v=19"),"ayrıştırıcı doğru sırada yükleniyor");
