...
function openExplanationReader(shell){
  ...
  var readerShell=reader.querySelector(".dh-exp-reader-shell");readerShell.appendChild(source.cloneNode(true));readerShell.setAttribute("role","document");readerShell.setAttribute("tabindex","0");document.body.appendChild(reader);document.documentElement.style.overflow="hidden";syncExplanationSize(size);reader.querySelector(".dh-exp-reader-body").scrollTop=0;readerShell.focus();
}
