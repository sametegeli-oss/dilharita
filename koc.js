...
(function(){
  ...
  // Tarih matematik ayrıştırması güvenli parçalara bölündü (Parantez Hatası Çözüldü)
  ...
  async function run(){
    try {
      ...
      const sys = `Sen DilHaritası ekosisteminde nöro-pedagoji ilkelerini kararlılıkla uygulayan üst düzey bir AI MENTOR ve EĞİTİM DİREKTÖRÜSÜN. Sadece saf, tek bir JSON döndür.`;
