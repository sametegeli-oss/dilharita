...
(function(global){
  ...
  (function(){if(document.querySelector('script[data-dh-word-study-list]'))return;var s=document.createElement("script");s.src="./word-learning-list.js?v=148";s.dataset.dhWordStudyList="1";document.head.appendChild(s);})();
})(window);
