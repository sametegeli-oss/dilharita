...
(function(global){
  ...
  function build(input){
    ...
    if(due>0) action={kind:"review",title:"Önce bekleyen tekrarları tamamla",detail:due+" kayıt tekrar için hazır.",href:"./tekrar.html?plan=1",label:"Tekrara başla"};
    ...
    else if(remaining>0) action={kind:"learn",title:"Günlük hedefine devam et",detail:remaining+" yeni cümle daha çalışınca bugünkü hedefin tamamlanacak.",href:"./index-app.html",label:"Cümle çalış"};
    else if(talks<1) action={kind:"talk",title:"Bildiklerini konuşmaya dönüştür",detail:"Cümle hedefin tamam. Şimdi en az bir dakikalık konuşma pratiği yap.",href:"./chat.html",label:"Konuşmaya başla"};
    else action={kind:"done",title:"Bugünkü planın tamamlandı",detail:"Yeni cümle, tekrar ve konuşma dengesini korudun. İstersen günü karma pratikle kapat.",href:"./chatteacher.html",label:"Karma pratik yap"};
